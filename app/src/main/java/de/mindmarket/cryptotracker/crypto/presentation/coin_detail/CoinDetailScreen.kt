...
import de.mindmarket.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import de.mindmarket.cryptotracker.crypto.presentation.coin_list.CoinListState
import de.mindmarket.cryptotracker.crypto.presentation.coin_list.components.previewCoin
import de.mindmarket.cryptotracker.crypto.presentation.models.toDisplayableNumber
...
fun CoinDetailScreen(
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            Icon(
                imageVector = ImageVector.vectorResource(coin.iconResource),
            ...
            FlowRow(
                ...
                InfoCard(
                    title = stringResource(R.string.change_last_24d),
